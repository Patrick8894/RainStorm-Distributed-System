...
type MembershipInfo_State int32

const (
	MembershipInfo_Suspected MembershipInfo_State = 0
	MembershipInfo_Alive     MembershipInfo_State = 1
	MembershipInfo_Down      MembershipInfo_State = 2
	MembershipInfo_Join      MembershipInfo_State = 3
)

// Enum value maps for MembershipInfo_State.
var (
	MembershipInfo_State_name = map[int32]string{
		0: "Suspected",
		1: "Alive",
		2: "Down",
		3: "Join",
	}
	MembershipInfo_State_value = map[string]int32{
		"Suspected": 0,
		"Alive":     1,
		"Down":      2,
		"Join":      3,
...
func (x MembershipInfo_State) Enum() *MembershipInfo_State {
	p := new(MembershipInfo_State)
	*p = x
	return p
}

func (x MembershipInfo_State) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MembershipInfo_State) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_swim_proto_enumTypes[1].Descriptor()
}

func (MembershipInfo_State) Type() protoreflect.EnumType {
	return &file_proto_swim_proto_enumTypes[1]
}

func (x MembershipInfo_State) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MembershipInfo_State.Descriptor instead.
func (MembershipInfo_State) EnumDescriptor() ([]byte, []int) {
	return file_proto_swim_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *SWIMMessage) GetTargetId() string {
	if x != nil {
		return x.TargetId
	}
	return ""
...
type MembershipInfo struct {
	...
	MemberStatus      MembershipInfo_State `protobuf:"varint,2,opt,name=memberStatus,proto3,enum=swim.MembershipInfo_State" json:"memberStatus,omitempty"` // Can be "Alive", "Suspected", or "Failed", "Join"
	MemberAddress     string               `protobuf:"bytes,3,opt,name=memberAddress,proto3" json:"memberAddress,omitempty"`
	MemberIncarnation int32                `protobuf:"varint,4,opt,name=memberIncarnation,proto3" json:"memberIncarnation,omitempty"`
}
...
func (x *MembershipInfo) GetMemberStatus() MembershipInfo_State {
	if x != nil {
		return x.MemberStatus
	}
	return MembershipInfo_Suspected
}

func (x *MembershipInfo) GetMemberAddress() string {
	if x != nil {
...
func (x *MembershipInfo) GetMemberIncarnation() int32 {
	if x != nil {
		return x.MemberIncarnation
	}
	return 0
}
...
var file_proto_swim_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x04, 0x73, 0x77, 0x69, 0x6d, 0x22, 0x8a, 0x02, 0x0a, 0x0b, 0x53, 0x57, 0x49,
	...
	,
}
...
var file_proto_swim_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_proto_swim_proto_goTypes = []any{
	...
	(MembershipInfo_State)(0),    // 1: swim.MembershipInfo.State
	(*SWIMMessage)(nil),          // 2: swim.SWIMMessage
	(*MembershipInfo)(nil),       // 3: swim.MembershipInfo
}
var file_proto_swim_proto_depIdxs = []int32{
	0, // 0: swim.SWIMMessage.type:type_name -> swim.SWIMMessage.MessageType
	3, // 1: swim.SWIMMessage.membership:type_name -> swim.MembershipInfo
	1, // 2: swim.MembershipInfo.memberStatus:type_name -> swim.MembershipInfo.State
