...
go run client.go create --localfilename ~/business/business_2.txt --HyDFSfilename business_2.txt && \
go run client.go create --localfilename ~/business/business_3.txt --HyDFSfilename business_3.txt && \
go run client.go create --localfilename ~/business/business_4.txt --HyDFSfilename business_4.txt && \
