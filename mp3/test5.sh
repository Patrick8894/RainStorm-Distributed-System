...
go run client.go getfromreplica --VMaddress fa24-cs425-6601.cs.illinois.edu --HyDFSfilename business_4.txt --localfilename ~/test6.txt
diff  ~/test5.txt ~/test6.txt
